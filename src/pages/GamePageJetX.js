...
const GamePageJetX = () => {
  ...
  const styles = {
    container: {
      width: '100%',
      height: '100vh',
      background: 'linear-gradient(-45deg, #001833, #002952, #003d73, #004c99)',
    ...
    numberBox: {
      ...
      fontWeight: '800',
      color: '#33ccff',
      textShadow: '0 0 10px rgba(51, 204, 255, 0.7)',
    ...
    status: {
      ...
      textShadow: '0 0 10px rgba(51, 204, 255, 0.5)',
      textAlign: 'center',
      width: '100%',
    },
    ...
    analyzeButton: {
      ...
      '&:hover': {
        ...
        boxShadow: '0 0 20px rgba(51, 204, 255, 0.5)',
      },
      margin: '0 auto',
      display: 'block',
    },
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        <img src={image4} alt="Character" style={styles.centerImage} />
